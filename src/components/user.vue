		...
		<el-dialog
			...
			<el-form :model="emailForm" ref="emailFormRef" :rules="emailRules" status-icon @submit.native.prevent>
				<el-form-item :label="t('userInfo.operate.email.new')" :error="emailError" prop="email">
					<el-input v-model="emailForm.email" autocomplete="off" @keyup.enter="confirmEmail(emailFormRef)"/>
				</el-form-item>
				<el-form-item>
			...
			<el-form :model="passwordForm" ref="passwordFormRef" :rules="passwordRules" 
				...
				<el-form-item :label="t('userInfo.operate.password.new')" :error="passwordError.newPassword" prop="newPassword">
					<el-input v-model="passwordForm.newPassword" autocomplete="off" 
						clearable show-password @keyup.enter="confirmPassword(passwordFormRef)"
					/>
				</el-form-item>
				<el-form-item>
